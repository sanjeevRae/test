...
import { doc, getDoc, setDoc, collection, addDoc, updateDoc, deleteDoc, query, where, getDocs, orderBy, Timestamp } from 'firebase/firestore';
...
const cloudinary = new Cloudinary({
  ...
  secure: true,
  cname: import.meta.env.VITE_CLOUDINARY_CNAME, 
});
...
try {
  ...
  // Initialize Analytics (only if supported and not in emulator mode)
...
export { 
  ...
  cloudinaryStorage, // Export the cloudinary storage functions
