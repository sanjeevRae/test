    ...
    <div style={{ 
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        <p style={{ marginBottom: '15px', color: '#4a5568' }}>
          Use this tool to fix the admin status for specific users.
        </p>
      ...
      <div style={{ marginTop: '30px', fontSize: '14px', color: '#718096' }}>
        ...
        <ul style={{ paddingLeft: '20px' }}>
          <li>This process cant be undo unless you edit on the database directly</li>
          <li>After making a user admin, they need to logout and login again to see the admin dashboard</li>
          <li>The role change is protected by Firestore rule version 2 Jestha 7 2082 </li>
        </ul>
      </div>
    </div>
  );
