...
const Dashboard = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToastMessage("Error saving card. Please try again.");
    } finally {
      setSaving(false);
    }
  };
  ...
  const copyShareUrl = () => {
    ...
    showToastMessage("Share URL copied to clipboard!");
  };
  ...
  return (
    <div className="dashboard-container">
      <div className="dashboard-header">
        ...
        <p className="dashboard-subtitle">Create and manage your professional digital business cards</p>
      </div>
