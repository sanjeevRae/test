    ...
    <div className="home-page">
      ...
      <section id="about" className="about-section workforce-hero" ref={aboutRef}>
        <div className="container">
         ...
         <section className="seven-preview-container">
           <div className="preview-section section-1">
             <div className="section-content">
               <h2>Digital Identity</h2>
               <p>Transform your professional presence with smart NFC technology</p>
               <video 
           ...
           <div className="preview-section section-2">
             <div className="section-content">
               ...
               <p>Share your details with just one tap - no apps required</p>
             </div>
           </div>
           ...
           <div className="preview-section section-3">
             <div className="section-content">
               <h2>Eco-Friendly</h2>
               <p>Replace hundreds of paper cards with one sustainable solution</p>
             </div>
           </div>
           ...
           <div className="preview-section section-4">
             <div className="section-content">
               ...
               <p>Cloud-based profiles ensure your information is never outdated</p>
             </div>
           </div>
           ...
           <div className="preview-section section-5">
             <div className="section-content">
               <h2>Multi-Profile</h2>
               <p>Switch between work, personal, and event profiles seamlessly</p>
             </div>
           </div>
           ...
           <div className="preview-section section-6">
             <div className="section-content">
               <h2>Analytics</h2>
               <p>Track your networking success with detailed insights</p>
             </div>
           </div>
           ...
           <div className="preview-section section-7">
             <div className="section-content">
               <h2>Future Ready</h2>
               <p>Quantum-resistant security for tomorrow's networking needs</p>
             </div>
           </div>
         </section>
