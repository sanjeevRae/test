  ...
  const convertToCSV = (data) => {
    ...
    const csvRows = [
      ...
      ...data.map(user => [
        ...
        escapeCSV(user.createdAt ? new Date(user.createdAt.seconds * 1000).toLocaleDateString() : ''),
        escapeCSV(user.subscriptionExpires ? new Date(user.subscriptionExpires.seconds * 1000).toLocaleDateString() : '')
      ].join(','))
    ];
