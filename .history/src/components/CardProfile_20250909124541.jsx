      ...
      <>
        <div className="card-profile-container card-profile-theme2">
          <div className="digital-card-theme2" ref={cardRef} style={{ display: 'flex', flexDirection: 'row', minHeight: 400 }}>
            ...
            <div
              className="theme2-left"
              style={{
                width: window.innerWidth <= 600 ? '25vw' : '180px',
                display: 'flex',
            ...
            >
              ...
              <h1 className="card-name" style={{ fontWeight: 700, color: '#fff', fontSize: '1 rem', textAlign: 'center', margin: 0 }}>{profile.name}</h1>
                  ...
                  <div className="social-links">
                    ...
                    {profile.socials && profile.socials.twitter && (
                      <a 
                        ...
                        onClick={async (e) => {
                          try {
                            await trackSocialLinkClick(userId, 'twitter', profile.socials.twitter);
                          } catch (error) {
                            console.error('Failed to track Twitter click:', error);
                          }
                        }}
                      >
                      </a>
