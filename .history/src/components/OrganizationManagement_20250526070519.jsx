...
const OrganizationManagement = () => {
  ...
  useEffect(() => {
    ...
    const testConnection = async () => {
      ...
      if (!connected) {
        setError('Database connection issue detected. Some features may not work properly.');
      }
  ...
  const handleUpdateUserRole = async (userId, newRole) => {
    try {
      ...
      // Leaders can't promote users to leader or admin
      ...
      try {
        ...
        if (result && result.success) {
          ...
          console.error('Role update failed with error:', errorMsg);
