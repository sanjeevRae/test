...
const Dashboard = () => {
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      ...
      // Create a unique path for the image in Cloudinary
      const path = `profile-photos/${currentUser.uid}/${Date.now()}_${file.name}`;
      
      // Upload file to Cloudinary via our storage adapter
