...
import { auth, db, doc, setDoc, getDoc, checkNetworkConnectivity } from '../utils/firebase';
...
const AuthForm = ({ isSignup = false }) => {
  ...
  const handleSignUp = async () => {
    try {
      // Check network connectivity again right before the request
      ...
      if (error.code === 'auth/network-request-failed' || error.message.includes('network') || !networkStatus) {
        setError('Network error. Please check your internet connection and try again.');
  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        ...
        <div className="auth-disclaimer"></div>
