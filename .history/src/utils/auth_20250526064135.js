...
export const isUserAdmin = async () => {
  try {
    console.log('⚠️ TEMPORARY ADMIN OVERRIDE ACTIVE! Remove in production!');
    return true; // Development mode: all users are admins
  } catch (error) {
    console.error('Error checking admin status:', error);
    return true; // Development mode: allow admin access despite errors
  }
};
...
export const isUserLeader = async () => {
  try {
    console.log('⚠️ TEMPORARY LEADER OVERRIDE ACTIVE!');
    return true; // Development mode: all users are leaders
  } catch (error) {
...
export const getUserRole = async () => {
  try {
    console.log('⚠️ TEMPORARY ROLE OVERRIDE ACTIVE!');
    return 'admin'; // Development mode: all users have admin role
  } catch (error) {
