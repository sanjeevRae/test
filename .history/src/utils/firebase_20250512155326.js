...
// These environment variables are exposed to the client, but this is expected for client-side Firebase apps
// The security is handled through Firebase Authentication and Security Rules
...
try {
  ...
  if (firebaseConfig.apiKey && firebaseConfig.authDomain && firebaseConfig.projectId) {
    ...
    console.error('Firebase initialization failed: Missing configuration values');
  }
} catch (error) {
