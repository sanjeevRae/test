...
export const setUserRole = async (userId, role, organizationId = null) => {
  try {
    ...
    if (organizationId) {
      try {
        ...
        try {
          ...
          console.error(`Error updating organization leaders array: ${leaderUpdateError.message}`);
    ...
    console.log(`Role change operation completed successfully for user ${userId}`);
    return { success: true };
  } catch (error) {
