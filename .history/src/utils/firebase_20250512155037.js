...
// Firebase config with direct values from .env to ensure they're properly loaded
...
const CLOUDINARY_CLOUD_NAME = "dnqa3pqtc";
const CLOUDINARY_API_KEY = "638125756951238";
const CLOUDINARY_UPLOAD_PRESET = "evox_uploads";
