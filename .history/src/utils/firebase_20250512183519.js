...
const cloudinaryStorage = {
  ...
  async uploadFile(file, path, options = {}) {
    ...
    try {
      ...
      // Add API key if available - this is for browser-based uploads that are allowed in your preset
      ...
      // Important: timestamp and signature are typically required for secure uploads
      // For unsigned uploads (using upload_preset) Cloudinary will handle this server-side
